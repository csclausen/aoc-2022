...
def elves_intersect(e1_range, e2_range):
    if int(e1_range[1]) >= int(e2_range[0]) and int(e1_range[1]) <= int(e2_range[1]):
        return True
    elif int(e1_range[0]) >= int(e2_range[0]) and int(e1_range[0]) <= int(e2_range[1]):
        return True
    return False
...
def main():
    ...
    for line in open("input.txt"):
        ...
        if elves_intersect(e1_range, e2_range) or elves_intersect(e2_range, e1_range):
            pairs += 1
